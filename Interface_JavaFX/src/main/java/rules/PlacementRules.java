...
public interface PlacementRules {
    ...
    /**
     * Adjusts the orientation of a face to fit at the specified position on the board.
     * Implementations of this method should apply rotation strategies to make the face compatible.
     *
     * @param x the x-coordinate on the board
     * @param y the y-coordinate on the board
     * @param face the face to be rotated for placement
     * @param board the game board
     */
    void adjustOrientation(int x, int y, AbstractFace face, Board board);
