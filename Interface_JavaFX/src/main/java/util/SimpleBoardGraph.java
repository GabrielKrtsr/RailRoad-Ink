...
public class SimpleBoardGraph {
    ...
    public void disconnectNodeSets(Set<Node> set1, Set<Node> set2) {
        graph.removeEdge(set1,set2);
    }

    public void removeNodeSet(Set<Node> nodeSet) {
        graph.removeVertex(nodeSet);
    }
}
