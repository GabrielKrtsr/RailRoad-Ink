...
public class FlippedLeftRotation implements RotationStrategy {
    ...
    public void rotate(AbstractFace face) {
        ...
        newTop = face.getNode(Side.TOP.getRightSide());
        newBottom = face.getNode(Side.BOTTOM.getRightSide());
        newLeft = face.getNode(Side.LEFT.getRightSide());
        newRight = face.getNode(Side.RIGHT.getRightSide());
...
//            rotatedSvgContent.insert(svgIndex + 2, " transform=\"rotate(-90, 125, 125) translate(250, 0) scale(-1, 1) \"");
...
//    }
        ...
        try {
            ...
            for (int i = 0; i < gElements.getLength(); i++) {
                ...
                if ("rail".equals(classAttribute) || "road".equals(classAttribute)) {
                    ...
                    String newTransform = "rotate(-90, 128, 128) translate(256, 0) scale(-1, 1)";
    ...
    public RotationStrategy getOppositeRotation() {
        return new FlippedRightRotation();
    }
}
