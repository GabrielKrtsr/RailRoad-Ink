...
public class FlippedRightRotation implements RotationStrategy {
    ...
    public void rotate(AbstractFace face) {
        ...
        newTop = face.getNode(Side.TOP.getLeftSide());
        newBottom = face.getNode(Side.BOTTOM.getLeftSide());
        newLeft = face.getNode(Side.LEFT.getLeftSide());
        newRight = face.getNode(Side.RIGHT.getLeftSide());
...
//    }
    ...
    public RotationStrategy getOppositeRotation() {
        return new FlippedLeftRotation();
    }
