...
public class FlippedUpsideDownRotation implements RotationStrategy {
    ...
    public void rotate(AbstractFace face) {
        ...
        newTop = face.getNode(Side.TOP.getOppositeSide());
        newBottom = face.getNode(Side.BOTTOM.getOppositeSide());
        newLeft = face.getNode(Side.LEFT.getOppositeSide());
        newRight = face.getNode(Side.RIGHT.getOppositeSide());
...
//            rotatedSvgContent.insert(svgIndex + 2, " transform=\"rotate(180, 125, 125) translate(247, 0) scale(-1, 1) \"");
...
//    }
        ...
        try {
            ...
            for (int i = 0; i < gElements.getLength(); i++) {
                ...
                if ("rail".equals(classAttribute) || "road".equals(classAttribute)) {
                    ...
                    String newTransform = "rotate(180, 128, 128) translate(256, 0) scale(-1, 1)";
    ...
    public RotationStrategy getOppositeRotation() {
        return new FlippedUpsideDownRotation();
    }
