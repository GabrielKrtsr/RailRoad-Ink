...
public class RotationFactory {
    ...
    /**
     * Retrieves all rotation strategies stored in the factory.
     *
     * @return A map of strategy names to their corresponding RotationStrategy instances.
     */
    public static Map<String, RotationStrategy> getStrategies() {
