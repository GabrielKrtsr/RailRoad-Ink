...
public class Edge<V> {
     ...
     */
    public Edge(V source, V target, double weight) throws IllegalArgumentException, NullPointerException {
        if (source == null || target == null) {
            throw new NullPointerException("Source and target vertices cannot be null");
        }
        if (weight < 0) {
