...
public class Node implements Cloneable {
    ...
    /**
     * Indicates whether the node is designated as a station node.
     * A station node typically represents a location within a network
     * that is associated with transportation or transit services.
     */
    ...
    /**
     * Indicates whether the current node is designated as a board node.
     * A board node might be used to represent a specific type of node
     * within a graph or network, such as one where particular operations
     * or attributes are relevant.
     *
     * The value is {@code true} if the node is marked as a board node, and
     * {@code false} otherwise.
     */
    private boolean isBoardNode;

    /**
     * Indicates whether this node is marked as a board node.
     *
     * @return true if the node is designated as a board node, false otherwise.
     */
    ...
    /**
     * Sets whether the node is designated as a board node.
     *
     * @param boardNode a boolean value indicating if the node should be marked as a board node.
     *                  Pass true to mark the node as a board node, or false otherwise.
     */
    ...
    /**
     * Determines whether the current node is designated as a station*/
    public boolean isStationNode() {
        return isStationNode;
    }

    /**
     * Sets whether the current node is designated as a station node.
     *
     * @param stationNode a boolean value indicating if the node should be marked
     *                    as a station node. Pass true to mark the node as a station
