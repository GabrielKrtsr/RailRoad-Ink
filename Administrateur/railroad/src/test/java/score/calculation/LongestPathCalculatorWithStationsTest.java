...
public class LongestPathCalculatorWithStationsTest extends LongestPathCalculatorTest{

    @Override
    protected LongestPathCalculator createCaulator(Path path) {
        return new LongestPathCalculatorWithStations(sumOperation,path.name(),path);
    }
    ...
    void testTwoConnectedNodesRail() {
        ...
        assertEquals(1, calculatorR.calculateScore(board));
    }
