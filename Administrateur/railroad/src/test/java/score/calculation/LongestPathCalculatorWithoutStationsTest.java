...
public class LongestPathCalculatorWithoutStationsTest extends LongestPathCalculatorTest{

    @Override
    protected LongestPathCalculator createCaulator(Path path) {
        return new LongestPathCalculatorWithoutStations(sumOperation,path.name(),path);
    }
